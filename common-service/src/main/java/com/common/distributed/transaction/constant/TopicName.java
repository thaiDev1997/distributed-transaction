...
public class TopicName {
    ...
    public static final String STOCK_RESERVE_COMMAND = "ReserveStock"; // command
    ...
    public static final String PAYMENT_PROCESS_COMMAND = "ProcessPayment"; // command
    ...
    public static final String DELIVERY_SCHEDULE_COMMAND = "ScheduleDelivery"; // command
